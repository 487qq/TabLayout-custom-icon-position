...
package com.max.library.view.v7;
...
import static com.max.library.view.v7.ThemeUtils.getDisabledThemeAttrColor;
import static com.max.library.view.v7.ThemeUtils.getThemeAttrColor;
import static com.max.library.view.v7.ThemeUtils.getThemeAttrColorStateList;
...
public final class AppCompatDrawableManager {
    ...
    private static final int[] COLORFILTER_COLOR_CONTROL_ACTIVATED = {
            ...
            com.max.library.R.drawable.abc_text_cursor_material
    };
    ...
    public final ColorStateList getTintList(@NonNull Context context, @DrawableRes int resId) {
        ...
        if (tint == null) {
            ...
            } else if (resId == com.max.library.R.drawable.abc_btn_colored_material) {
            ...
            } else if (resId == com.max.library.R.drawable.abc_seekbar_thumb_material) {
